...
public class mortgageControllerTest {
    ...
    /**
     * Method under test: {@link mortgageController#addMortgage(MortgageRegistrationDTO, Long)}
     */
    @Test
     ...
     */
    @Test
    public void testDeleteMortgage() throws Exception {
        doNothing().when(mortgageRepository).deleteById(Mockito.<Long>any());
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/mortgage/delete_mortgage/{mid}",
                1L);
        MockMvcBuilders.standaloneSetup(mortgageController)
                .build()
                .perform(requestBuilder)
     ...
     */
    @Test
    public void testDeleteMortgage2() throws Exception {
        doNothing().when(mortgageRepository).deleteById(Mockito.<Long>any());
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/mortgage/delete_mortgage/{mid}",
                1L);
     ...
     */
    @Test
    public void testGetMortgageByCustomer() throws Exception {
        Customer customer = new Customer();
        customer.setAddress("42 Main St");
        customer.setContact("Contact");
        customer.setEmail("jane.doe@example.org");
     ...
     */
    @Test
    public void testGetMortgages2() throws Exception {
        Customer customer = new Customer();
        customer.setAddress("42 Main St");
        customer.setContact("?");
        customer.setEmail("jane.doe@example.org");
    ...
    /**
     * Method under test: {@link mortgageController#updateMortgage(MortgageUpdateDto, Long)}
     */
    @Test
    public void testUpdateMortgage() throws Exception {
        Customer customer = new Customer();
        customer.setAddress("42 Main St");
        customer.setContact("Contact");
        customer.setEmail("jane.doe@example.org");
     ...
     */
    @Test
    public void testUpdateMortgage2() throws Exception {
        Customer customer = new Customer();
        customer.setAddress("42 Main St");
        customer.setContact("Contact");
        customer.setEmail("jane.doe@example.org");
        ...
        MortgageUpdateDto mortgageUpdateDto = new MortgageUpdateDto("Product Name", 0.0f, 10.0f, 10.0f, mock(Date.class),
                mock(Date.class), 10.0f);
        mortgageUpdateDto.setLastPaid(null);
        mortgageUpdateDto.setIssueDate(null);
        String content = (new ObjectMapper()).writeValueAsString(mortgageUpdateDto);
     ...
     */
    @Test
    public void testUpdateMortgage3() throws Exception {
        Customer customer = new Customer();
        customer.setAddress("42 Main St");
        customer.setContact("Contact");
        customer.setEmail("jane.doe@example.org");
        ...
        MortgageUpdateDto mortgageUpdateDto = new MortgageUpdateDto("Product Name", 10.0f, 0.0f, 10.0f, mock(Date.class),
                mock(Date.class), 10.0f);
        mortgageUpdateDto.setLastPaid(null);
        mortgageUpdateDto.setIssueDate(null);
        String content = (new ObjectMapper()).writeValueAsString(mortgageUpdateDto);
     ...
     */
    @Test
    public void testUpdateMortgage4() throws Exception {
        Customer customer = new Customer();
        customer.setAddress("42 Main St");
        customer.setContact("Contact");
        customer.setEmail("jane.doe@example.org");
        ...
        MortgageUpdateDto mortgageUpdateDto = new MortgageUpdateDto("Product Name", 10.0f, 10.0f, 0.0f, mock(Date.class),
                mock(Date.class), 10.0f);
        mortgageUpdateDto.setLastPaid(null);
        mortgageUpdateDto.setIssueDate(null);
        String content = (new ObjectMapper()).writeValueAsString(mortgageUpdateDto);
     ...
     */
    @Test
    public void testUpdateMortgage5() throws Exception {
        Customer customer = new Customer();
        customer.setAddress("42 Main St");
        customer.setContact("Contact");
        customer.setEmail("jane.doe@example.org");
     ...
     */
    @Test
    public void testUpdateMortgage6() throws Exception {
        Customer customer = new Customer();
        customer.setAddress("42 Main St");
        customer.setContact("Contact");
        customer.setEmail("jane.doe@example.org");
